...
extract(){
    ...
    while(this.heap[current] > this.heap[(current * 2)] || this.heap[current] > this.heap[(current * 2) + 1]){
        if(this.heap[(current * 2)] < this.heap[(current * 2) + 1] && this.heap[(current * 2)] != null){
            [this.heap[(current * 2)], this.heap[current]] = [this.heap[current], this.heap[(current * 2)]];
            current = (current * 2)
        }
        if(this.heap[(current * 2)] < this.heap[(current * 2) + 1] && this.heap[(current * 2) + 1] != null){
            [this.heap[(current * 2) + 1], this.heap[current]] = [this.heap[current], this.heap[(current * 2) + 1]];
                current = (current * 2) + 1;
        }
        else {
            break;
